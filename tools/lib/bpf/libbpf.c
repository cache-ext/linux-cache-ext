...
{
	struct bpf_link_cache_ext_ops *st_link;
	__u32 zero = 0;

	st_link = container_of(link, struct bpf_link_cache_ext_ops, link);
...
{
	struct bpf_link_cache_ext_ops *link;
	__u32 zero = 0;
	int err, fd;
