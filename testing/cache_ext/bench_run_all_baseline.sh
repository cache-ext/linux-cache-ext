...
#     --cpu 8 \
#     --policy-loader ./baseline_cache_ext_sampling.out \
...
#     --results-file ./baseline_filesearch_results.json  \
#     --data-dir /mydata/filesearch_data

# for cluster in 17 18 24 34 52; do
#     python3 bench_twitter_trace.py \
#         --cpu 8 \
#         --results-file ${RESULTS_FOLDER}/baseline_twitter_traces_${cluster}.json \
...
python3 bench_leveldb.py \
    --cpu 8 \
    --results-file $RESULTS_FOLDER/baseline_lfu_ycsb_results.json \
    --leveldb-db /mydata/leveldb_db \
    --fadvise-hints "" \
