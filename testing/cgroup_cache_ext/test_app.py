...
def create_test_file(path, size_in_bytes):
    with open(path, "wb") as f:
        f.write(os.urandom(size_in_bytes))


def test_file_exists(path, size_in_bytes):
...
def main():
    ...
    if not test_file_exists(args.name,args.workingset_size):
        create_test_file(args.name,args.workingset_size)
